/* eslint-disable prefer-const, eqeqeq, no-param-reassign, @typescript-eslint/strict-boolean-expressions, regexp/strict */
...
const snippetKeymap = Facet.define<readonly KeyBinding[], readonly KeyBinding[]>({
  combine(maps) {
